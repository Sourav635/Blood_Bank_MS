...
class Main(Widgets):            # Main Class containing all function and Windows
    ...
    def donor(self):
        ...
        self.scr.iconbitmap(cwd + r"\bank.ico")
        self.scr.title("Bank Management System")
        ...
        heading = Label(self.scr, text="Account Registration Form", font="Ubuntu 14 bold underline", bg="Silver", width="65").grid(
        ...
        self.blood_grp_char.set("Saving")
        self.blood_grp_sign.set("+")

        Blood_Group_Label = self.tag(self.scr, "Account Type", 5, 6, 0)
        Blood_Group_char_Option_Menu = OptionMenu(
            self.scr, self.blood_grp_char, "Current", "Saving")
        Blood_Group_char_Option_Menu.grid(row=6, column=1)
        Blood_Group_char_Option_Menu.config(width="8")
        ...
        # --> Date Label && Entry
        date_label = self.tag(self.scr, "D.O.B (mm/dd/yy)", 5, 10, 0,
    ...
    def homescr(self):
        ...
        self.home.iconbitmap(cwd + r"\bank.ico")
